...
module Config
  ...
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/local/ruby-mingw32")
  CONFIG["EXEEXT"] = ".exe"
  ...
  CONFIG["configure_args"] = " '--host=i386-mingw32' '--target=i386-mingw32' '--build=i686-darwin9.2.2' '--prefix=/opt/local/ruby-mingw32' 'build_alias=i686-darwin9.2.2' 'host_alias=i386-mingw32' 'target_alias=i386-mingw32'"
